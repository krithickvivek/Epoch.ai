...
TOPIC_ABBREV = [
    "NUM", "HCF", "PCT", "P&L", "RAT", "T&W", "T&D", "SI", "CI", "AVG",
    "AGE", "P&C", "COD", "BLD", "DIR", "SEA", "SYL", "SER", "ANA", "LOG",
    "SYN", "ANT", "SEN", "RC", "PJ", "ERR", "IDM", "TBL", "BAR", "PIE",
    "LIN", "CB", "DT", "CF", "A&S", "PTR", "OOP", "DS", "ALG", "SQL",
    "ARR", "LL", "S&Q", "TRE", "GRA", "HSH", "DP", "S&S", "REC", "GRD",
    "BIT", "STR", "OSP", "OSM", "OSD", "DBN", "DBT", "CNO", "CNP", "ODP",
    "TCS", "INF", "WIP", "ACC", "AMZ", "MSF",
]
